...
version 4 for starter code of Feb. 18 or later.
...
def run(the_globals):
    ...
    g['MDP_command']("NDISKS",3)
    # Set the MDP to have two goal states.
    g['MDP_command']("ngoals",1)
    ...
    g['train_until'](criterion="Policy match on golden path", threshold=1, max_iterations=10000)
