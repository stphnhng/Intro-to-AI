'''Vis_TOH_MDP.py
Version 0.7a, S. Tanimoto, Feb. 18, 2018.
...
NOISE_VAR=None; NGOALS_VAR=None; R_VAR=None; G_VAR=None; DISPLAY_VALS_VAR=None; Q_VAR=None; EPSILON_VAR=None; EXPL_VAR=None
...
def add_compare_menu_item():
  # This is called if the Compare_QLearn_to_VI module is available
  # in the folder.
  global COMPARE_VAR
...
VALUE_FONT = None
MDP_command = None
def basic_plot(SEdict, ndisks, mdp_command):
    ...
    global DISPLAY_VALS_VAR, PI_LINE_BUFS, VI_POLICY_VAR, QL_POLICY_VAR
